	...
	<div class="page">
        ...
        <div class="section-group">
            <div class="section section-apps">
                ...
                <div class="appPopupWrapper" :style="{'display': showPopup ? 'block' : 'none'}">
                    <Card class="appPopup">
                        <template #content>
                            <div class="appPopupCloseWrapper" style="" @click="closePopupWrapper"><i class="pi pi-times"></i></div>
...
export default defineComponent({
    ...
    created() {
        ...
        this.showPopup = this.isConnected
    ...
    methods: {
        ...
        showSticky(message: String, header: String, type: String) {
            this.$toast.add({ severity: type, summary: header, detail: message, life: 3000});
        },
        async fetchApps() {
