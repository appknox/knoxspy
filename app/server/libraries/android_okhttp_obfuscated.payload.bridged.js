📦
464810 /libraries/android_okhttp_obfuscated.payload.entry.js
289208 /libraries/android_okhttp_obfuscated.payload.entry.js.map
✄
...
// libraries/android_okhttp_obfuscated.payload.js
(function() {
  function getJavaApi() {
  ...
  function startWithRetry(remainingRetries) {
    ...
    JavaApi.perform(function() {
      ...
      var JArrays = Java2.use("java.util.Arrays");
      var JString = Java2.use("java.lang.String");
      var ObfRequest = Java2.use("okhttp3.v");
      var ObfRequestBody = Java2.use("okhttp3.w");
      var ObfResponseBody = Java2.use("okhttp3.y");
      var ObfByteString = Java2.use("i.h");
      var codecState = {};
      var pendingBodies = {};
      var pendingSources = {};
      ...
      function decodeByteString(bsObj) {
        if (!bsObj) return "";
        try {
          bsObj = Java2.cast(bsObj, ObfByteString);
        } catch (castErr) {
        }
        try {
          var b1 = bsObj.f();
      ...
      function extractBodyViaWriteTo(bodyObj) {
        ...
        try {
          try {
            bodyObj = Java2.cast(bodyObj, ObfRequestBody);
          } catch (castErr) {
          }
          var BufferClass = Java2.use("i.e");
      ...
      function isBinaryContentType(contentType) {
        ...
        if (!ct) return false;
        return ct.indexOf("application/zip") >= 0 || ct.indexOf("application/octet-stream") >= 0 || ct.indexOf("application/pdf") >= 0 || ct.indexOf("image/") >= 0 || ct.indexOf("audio/") >= 0 || ct.indexOf("video/") >= 0;
      }
      function extractResponseBodyViaSource(bodyObj, responseHeaders) {
        ...
        try {
          try {
            bodyObj = Java2.cast(bodyObj, ObfResponseBody);
          } catch (castErr) {
          }
      ...
      function extractRequest(reqObj) {
        ...
        try {
          try {
            reqObj = Java2.cast(reqObj, ObfRequest);
          } catch (castErr) {
          }
      ...
      function installResponseSourceHooks() {
        function hookSourceClass(className) {
          try {
            var Source = Java2.use(className);
...
// libraries/android_okhttp_obfuscated.payload.entry.ts
