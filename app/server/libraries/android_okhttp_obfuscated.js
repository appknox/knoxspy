    ...
    (function() {
      ...
      function startWithRetry(remainingRetries) {
        ...
        JavaApi.perform(function() {
          var Java2 = JavaApi;
          var JArray = Java2.use("java.lang.reflect.Array");
          var JString = Java2.use("java.lang.String");
          var codecState = {};
          var pendingBodies = {};
          ...
          function extractRequest(reqObj) {
            ...
            try {
              req.method = getHttpMethodFromFields(reqObj);
              var urlObj = getFirstFieldByType(reqObj, "okhttp3.p");
              var headersObj = getFirstFieldByType(reqObj, "okhttp3.o");
              var bodyObj = getFirstFieldByType(reqObj, "okhttp3.w");
          ...
          function extractResponse(respObj) {
            ...
            eachField(respObj, function(field) {
              try {
                ...
                if (!out.status_code && t === "int") {
                  var code3 = parseInt(safeToString(value), 10);
                  if (!isNaN(code3) && code3 >= 100 && code3 <= 599) out.status_code = code3;
                }
            ...
            if (!out.status_code && responseText) {
              var cm2 = /code=(\d{3})/.exec(responseText);
              if (cm2 && cm2[1]) out.status_code = parseInt(cm2[1], 10);
            }
            ...
            if (out.status_code) {
              var statusLine = protocolString(protoObj, responseText) + " " + out.status_code + (out.message ? " " + out.message : "");
          ...
          function installResponseBodyHooks() {
            try {
              var RespBody = Java2.use("okhttp3.y");
          ...
          try {
            var ObfOkHttpClient = Java2.use("okhttp3.s");
          ...
          try {
            var ObfRealCall = Java2.use("okhttp3.u");
          ...
          try {
            var ObfCodec = Java2.use("okhttp3.c0.d.a");
            ...
            if (ObfCodec.v && ObfCodec.v.overloads) {
              ObfCodec.v.overloads.forEach(function(ov) {
                ...
                if (args.length === 2 && args[0].className === "okhttp3.o" && args[1].className === "java.lang.String") {
...
var require_index = __commonJS({
  "index.ts"(exports) {
    ...
    var frida_java_bridge_1 = __importDefault((init_frida_java_bridge(), __toCommonJS(frida_java_bridge_exports)));
