📦
10541 /agent/index.js
5926 /agent/index.js.map
✄
...
var require_index = __commonJS({
  "agent/index.ts"() {
    ...
    var Socket_WriteList = libFlutter.base.add(8879008);
    ...
    Interceptor.attach(libFlutter.base.add(8903052), {
      // Interceptor.attach(libFlutter.base.add(0x9753D0), { // dio x86_64
      // Interceptor.attach(libFlutter.base.add(0x6331D0).add(1), { // dio arm32
      onEnter(args) {
    ...
    Interceptor.attach(libFlutter.base.add(7585616), {
      // Interceptor.attach(libFlutter.base.add(0x7D41C8), { // dio x86_64
      // Interceptor.attach(libFlutter.base.add(0x505DF4).add(1), { // dio arm32
      onEnter(args) {
    ...
    Interceptor.attach(libFlutter.base.add(7583556), {
      // Interceptor.attach(libFlutter.base.add(0x7D36D4), { // dio x86_64
      // Interceptor.attach(libFlutter.base.add(0x50569C).add(1), { // dio arm32
      onEnter(args) {
    ...
    Interceptor.attach(libFlutter.base.add(7582412), {
      // Interceptor.attach(libFlutter.base.add(0x505340).add(1), { // dio arm32
      onEnter(args) {
